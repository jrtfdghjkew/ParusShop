            ...
            <div className={style.sale}>
                <div className={style.sale__title}>
                    <div className={style.sale__title__left}>
                        <div className={style.sale__title__left__text}>Акционные товары</div>
                        <div className={style.sale__title__left__svg}>
                            <img src={SvgSale} alt=""/>
                        </div>
                    </div>
                    <div className={style.sale__title__right}>
                        <div className={style.sale__title__right__text}>Смотреть все товары</div>
